...
public class DataSourceConfig extends DataSourceConfiguration {
  ...
  public HikariDataSource hikariDataSource() {
    ...
    DATASOURCE_PROPS.tryProperty(DatabaseDefinition.DRIVER_CLASS).ifPresent(ds::setDriverClassName);
  ...
  @Bean
  public DataSourceDefinitions dataSourceDefinitions(HikariDataSource ds) {
